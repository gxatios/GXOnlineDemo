...
//
#define  LoadMoreViewHight 44.0f
#define lessHight 30
...
-(void)loadMoreScrollViewDidScroll:(UIScrollView *)scrollView{
    if (_state == LoadMoreLoading) {
        ...
        if (_state == LoadMorePulling && scrollView.contentOffset.y + (scrollView.frame.size.height) + lessHight< scrollView.contentSize.height + LoadMoreViewHight && scrollView.contentOffset.y > 0.0f && !_loading) {
            [self setState:LoadMoreNormal];
        } else if (_state == LoadMoreNormal && scrollView.contentOffset.y + (scrollView.frame.size.height) + lessHight> scrollView.contentSize.height + LoadMoreViewHight  && !_loading) {
...
- (void)loadMoreshScrollViewDidEndDragging:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.y + (scrollView.frame.size.height) + lessHight> scrollView.contentSize.height + LoadMoreViewHight && !_loading) {
